...
public:
	...
	Effect(ID3D11Device *device, const char *vertexShaderPath, const char * pixelShaderPath, const char * geometryShaderPath, const D3D11_INPUT_ELEMENT_DESC vertexDesc[], UINT numVertexElements, const D3D11_SO_DECLARATION_ENTRY streamOutDesc[]);
