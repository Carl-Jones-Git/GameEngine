...
public:
	...
	void setDiffuseTextCoords(int channel) {cBufferModelCPU->diffuseTextCoords = channel;};
	void setNormalTextCoords(int channel) { cBufferModelCPU->normalTextCoords = channel; };
