...
//using namespace DirectX::XMFLOAT4X4;
...
namespace DisplayMetrics
{
	...
	//static const float WidthThreshold = 600.0f;	// 1080p width.
	//static const float HeightThreshold = 480.0f;	// 1080p height.
};
...
void DX::DeviceResources::CreateDeviceResources() 
{
	...
	hr = D3D11CreateDevice(
		defaultAdapter,					// Specify nullptr to use the default adapter.
...
void DX::DeviceResources::CreateWindowSizeDependentResources() 
{
	...
	//shaderResourceViewDesc.ViewDimension = D3D11_SRV_DIMENSION_TEXTURE2D;//not using MS
