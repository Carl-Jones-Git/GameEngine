...
public:
	...
	FirstPersonCamera(ID3D11Device *device, DirectX::XMVECTOR init_pos, DirectX::XMVECTOR init_up, DirectX::XMVECTOR init_dir) :Camera(device, init_pos, init_up, DirectX::XMVectorAdd(init_pos , init_dir)){ dir = init_dir; };// -XMVector4Normalize(init_lookAt - init_pos)
	~FirstPersonCamera() {};
