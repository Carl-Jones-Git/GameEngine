...
{
    //PxPlaneGeometry lDrivableGroundPlane;
    physx::PxFilterData groundPlaneSimFilterData(COLLISION_FLAG_GROUND, COLLISION_FLAG_CHASSIS, 0, 0);
    //PxRigidStatic* lDrivableGroundPlane = createDrivablePlane(groundPlaneSimFilterData, mMaterial, mPhysics);
    //mScene->addActor(*lDrivableGroundPlane);
    ...
    //physx::PxTransform th(physx::PxVec3(-50, -0.1 - 0.23f, -50));
