/*
 * Educational Game Engine - Reflection Map Pixel Shader
...
static float FresnelBias = 0.0;
static float FresnelExp = 1.0;
...
FragmentOutputPacket main(FragmentInputPacket v) {
	...
	finalColour += specFactor * specular.xyz * lightSpecular;
