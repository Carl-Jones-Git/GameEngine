...
#pragma region 1. Initialise application
	...
	try
	{
		...
		//mainScene = Scene::CreateScene(1280, 1024, L"DirectX 11", L"DirectX 11", nCmdShow, hInstance, WndProc);
		mainScene = Scene::CreateScene(1366, 768, L"DirectX 11", L"DirectX 11", nCmdShow, hInstance, WndProc);
		//mainScene = Scene::CreateScene(1680, 1050, L"DirectX 11", L"DirectX 11", nCmdShow, hInstance, WndProc);
		//mainScene = Scene::CreateScene(1920, 1080, L"DirectX 11", L"DirectX 11", nCmdShow, hInstance, WndProc);
		//mainScene = Scene::CreateScene(3440, 1440, L"DirectX 11", L"DirectX 11", nCmdShow, hInstance, WndProc);
